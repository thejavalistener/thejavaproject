...
public class UBean
{
	...
	public static Object invokeGetter(Object tgt, String attName)
	{
		try
		{
			...
			// obtengo un puntero al metodo de acceso; el 
			// segundo argumento (null) indica que,
			// de estar sobrecargado, me interesa la version 
			// del metodo que no recibe argumentos
	...
	// invoca el setter correspondiente al atributo attName 
	// sobre el objeto tgt asignando el valor value
	public static void invokeSetter(Object tgt, String attName, Object value)
	{
		try
		{
			...
			// obtengo un puntero al setter; de estar sobrecargado 
			// me interesa la version del metodo que recibe un unico 
			// argumento cuyo tipo coincide con el del atributo f
			Method mtd=tgt.getClass().getMethod(setterName,f.getType());
			
			// invoco al setter pasandole el objeto value (que 
	...
	public static String[] getAttNames(Class<?> c)
	{
		...
		// recorro los getters y para cada uno busco que 
		// exista un setters relacionado
		...
		for(String getter:getters)
		{
			...
			{
				// si para este getter existe un setter 
				// entonces: ES UN ATRIBUTO!
	...
	// dado el nombre de un setter o un getter, retorna el 
	// nombre del atributo relacionado
